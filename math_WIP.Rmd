...
$$
\forall y \in Y,  \tilde\theta \in \Theta, x \in [0, 1] : r_{\phi, f}(x | \tilde\theta, y) = r_{\phi, g}(1 - x | \tilde\theta, y) \\
\forall y \in Y,  \tilde\theta \in \Theta, i \in \{0, \dots, M \} : R_{\phi, f}(i | \tilde\theta, y) = R_{\phi, g}(M - i | \tilde\theta, y)
$$
...
R_{\phi,g}(M - i | \tilde\theta, y) = \mathbb{P} \left(N^g_{\mathtt{less}} + K \leq M - i \right) =
  \mathbb{P} \left(M - N^f_{\mathtt{less}} - N^f_\text{equals} + K \leq M - i \right) = \\
  \mathbb{P} \left(N^f_{\mathtt{less}} + N^f_\text{equals} - K \geq   i \right) = \\
  1 - \mathbb{P} \left(N^f_{\mathtt{less}} + K \leq   i + 1 \right) = \\
  1 - R_{\phi,f}(i + 1 | \tilde\theta, y)
$$

$$
Q_{\phi,g}(i | y) = \int_\Theta \mathrm{d}\tilde\theta \: \pi_\text{post}(\tilde\theta|y)  R_{\phi,g}(i| \tilde\theta, y) = \\
\int_\Theta \mathrm{d}\tilde\theta \: \pi_\text{post}(\tilde\theta|y) - \int_\Theta \mathrm{d}\tilde\theta \: \pi_\text{post}(\tilde\theta|y) R_{\phi,g}(i + 1| \tilde\theta, y) = \\
1 - Q_{\phi,g}(i + 1|y)
$$
...
$$
r_{\phi, g}(1 - x | \tilde\theta, y) = \mathbb{P}\left(C_{\phi,g} \left(g \left(\tilde\theta, y \right) | y \right) - e D_{\phi,g} \left(g \left(\tilde\theta, y \right) | y \right) \leq 1 - x\right) = \\
\mathbb{P}\left(C_{\phi,g} \left(-f \left(\tilde\theta, y \right) | y \right) - e D_{\phi,f} \left(f \left(\tilde\theta, y \right) | y \right) \leq 1 - x\right) =  \\
\mathbb{P}\left(1 - C_{\phi,f} \left(f \left(\tilde\theta, y \right) | y \right) + (1 - e) D_{\phi,f} \left(f \left(\tilde\theta, y \right) | y \right) \leq 1 - x\right) = \\
\mathbb{P}\left( C_{\phi,f} \left(f \left(\tilde\theta, y \right) | y \right) - (1 - e) D_{\phi,f} \left(f \left(\tilde\theta, y \right) | y \right) \geq  x\right) = \\
1 - \mathbb{P}\left( C_{\phi,f} \left(f \left(\tilde\theta, y \right) | y \right) - (1 - e) D_{\phi,f} \left(f \left(\tilde\theta, y \right) | y \right) \leq  x\right) = \\
1 - r_{\phi, f}(x | \tilde\theta, y)
$$
