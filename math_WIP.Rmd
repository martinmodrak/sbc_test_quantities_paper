...
$$
2x =  2 \Phi^{-1}(x - 1 + h_0|0) - \left( \Phi^{-1}(x - 1 + h_0 | 0)\right)^2 + \left(\Phi^{-1}(x + h_1 | 1)\right)^2 \\
\Phi^{-1}(x + h_1 | 1) = \sqrt{\left( \Phi^{-1}(x - 1 + h_0 | 0)\right)^2 -  2 \Phi^{-1}(x - 1 + h_0|0) + 2x}
$$
Third, when $1 - h_1 \leq x \leq 1 - h_0$

$$
2x = 2 \Phi^{-1}(x + h_0 | 0)  -\left(\Phi^{-1}(x + h_0 | 0)\right)^2 + \left( \Phi^{-1}(x - 1 + h_1|1)\right)^2 \\
\Phi^{-1}(x - 1 + h_1|1) = \sqrt{\left(\Phi^{-1}(x + h_0 | 0)\right)^2 - 2 \Phi^{-1}(x + h_0 | 0) + 2x}
$$

And lastly, when $x \geq \max\{1 - h_0, 1 - h_1\}$

$$
2x = 1 - \left( \Phi^{-1}(x - 1 + h_0 | 0)\right)^2 + 2 \Phi^{-1}(x - 1 + h_0|0) + \left( \Phi^{-1}(x - 1 + h_1|1)\right)^2 \\
\Phi^{-1}(x - 1 + h_1|1) = \sqrt{\left( \Phi^{-1}(x - 1 + h_0 | 0)\right)^2 - 2 \Phi^{-1}(x - 1 + h_0|0) + 2x - 1} 
$$
...
\Phi^{-1}(y | 1) = 
  \begin{cases}
    ...
    & \text{for } y  \leq \bar{h} \\
    \sqrt{\left( \Phi^{-1}(y - \bar{h} | 0)\right)^2 - 2 \Phi^{-1}(y - \bar{h}|0) + 2y - 2\bar{h} +  2h_0+1} 
...
Since we need to ensure $\Phi^{-1}(0 | 1) = 1$ we obtain:

$$
1 =   
  \begin{cases}
    \sqrt{\left(\Phi^{-1}(1 - h_1 + h_0  | 0) - 1 \right)^2 + 2(1  - h_1)}
    & \text{for }  0 \leq \bar{h} \\
    \sqrt{\left( \Phi^{-1}(h_0  - h_1 | 0)\right)^2 -  2 \Phi^{-1}(  - h_1 + h_0|0) + 2(1 -  h_1)}
    & \text{for } \bar{h} < 0  \\
  \end{cases}
$$
...
0 =   
\begin{cases}
    \left(\Phi^{-1}(1 - h_1 + h_0 | 0)\right)^2 - 2 \Phi^{-1}(1 - h_1 + h_0 | 0) + 2(1 - h_1)
    & \text{for } 0  \leq \bar{h} \\
    \left(\Phi^{-1}(h_0 - h_1  | 0) - 1 \right)^2 -2h_1
    & \text{for } \bar{h} < 0 
  \end{cases}
$$

$$
\left(\Phi^{-1}(h_0 - h_1  | 0) - 1 \right)^2 -2h_1 = 0 \\
1 - \Phi^{-1}(h_0 - h_1  | 0) = \sqrt{2h_1} \\
\Phi^{-1}(h_0 - h_1  | 0) = 1 - \sqrt{2h_1}
$$

$$
\left(\Phi^{-1}(1 - h_1 + h_0 | 0)\right)^2 - 2 \Phi^{-1}(1 - h_1 + h_0 | 0) + 2(1 - h_1) = 0 \\
\left(\Phi^{-1}(1 - h_1 + h_0 | 0) - 1\right)^2 + 1 - 2h_1 = 0 \\
1 - \Phi^{-1}(1 - h_1 + h_0 | 0) = \sqrt{2h_1 - 1} \\
