...
N_sims_disc_gq <- 1000
N_sims_disc_gq_large <- 10000

theta_options <- c(1/4, 2/3)
...
disc_backend_func_invcdf <- function(tfunc0, tfunc1) {
  structure(list(tfunc0 = tfunc0, tfunc1 = tfunc1), class = "disc_backend_func_invcdf")
}
...
res_disc_gq_ok <- compute_SBC(datasets_disc_gq, backend_disc_gq_ok, keep_fits = FALSE,
