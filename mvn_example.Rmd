...
```{r}
plot_log_gamma_history(res_prior_only, max_sim_id = 1000, variables_regex = "^mu")
```
...
```{r, fig.width=hist_plot_width, fig.height=hist_plot_height}
p_hist_non_mon <- plot_log_gamma_history(res_non_mon, ylim = c(-30, 5), max_sim_id = 500)
p_hist_non_mon
...
```{r}
plot_ecdf_diff(bind_results(res_non_mon, res_non_mon_2))
```
