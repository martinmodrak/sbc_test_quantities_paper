...
```{r}
plot_log_gamma_history(res_one_missing, max_sim_id = 300)
```
...
```{r}
plot_log_gamma_history(res_corr_gq, max_sim_id = 100)
```
...
```{r}
plot_log_gamma_history(res_non_mon, max_sim_id = 500)
...
```{r}
plot_log_gamma_history(res_small_change, max_sim_id = 500)
```
