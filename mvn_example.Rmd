...
p_hist_correct
ggsave(file.path(fig_dir, "hist_correct.pdf"), p_hist_correct, width = 7, height = 5)
```
...
p_hist_prior_only
ggsave(file.path(fig_dir, "hist_prior_only.pdf"), p_hist_prior_only, width = 7, height = 5)
```
...
```{r}
p_hist_one_missing <- plot_log_gamma_history(res_one_missing, max_sim_id = 50)
p_hist_one_missing
ggsave(file.path(fig_dir, "hist_one_missing.pdf"), p_hist_one_missing, width = 7, height = 5)
```
...
p_hist_corr
ggsave(file.path(fig_dir, "hist_corr.pdf"), p_hist_corr, width = 7, height = 5)
```
...
```{r}
p_hist_non_mon <- plot_log_gamma_history(res_non_mon, max_sim_id = 500)
p_hist_non_mon
ggsave(file.path(fig_dir, "hist_non_mon.pdf"), p_hist_non_mon, width = 7, height = 5)
```
...
p_hist_small_change
ggsave(file.path(fig_dir, "hist_small_change.pdf"), p_hist_small_change, width = 7, height = 5)
```
